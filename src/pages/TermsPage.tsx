...
import { BreadcrumbLink, defaultTheme } from '../theme';
...
export const TermsPage: React.FC = () => (
  <ThemeProvider theme={defaultTheme}>
    ...
    <main>
      ...
      >
        <Container maxWidth="lg">
          <Typography component="h1" variant="h4" pb="40px" fontWeight={700}>
            Privacy Policy
          </Typography>
          ...
          <NavLink to="/sign-in">
            <Button variant="outlined" sx={{ width: '108px' }}>
              Back
            </Button>
          </NavLink>
        </Container>
